...
function putData(req){
    var personalDetails ={
       ...
       var languageDetails={};
       console.log(fields.languages);
       for(i=0;i<fields.languages.length;i++){
           var obj ={
               "language":checkValue(fields.languages[i]),
               "read":checkValue(req.query[(fields.languages[i]+"R")]),
               "write":checkValue(req.query[(fields.languages[i]+"W")]),
               "speak":checkValue(req.query[(fields.languages[i]+"S")])
           }
           languageDetails[i] = obj;
       }
       /*
       Technologies Known
       */
       ...
       var technologyDetails = {
        ...
        var technologyDetails={};
       for(i=0;i<fields.technologies.length;i++){
           console.log()
           var obj ={
               "techonology":checkValue(fields.technologies[i]),
               "level":checkValue(req.query[("Level"+fields.technologies[i])])
           }
           technologyDetails[i] = obj;
       }
        /*
        Contact
        */
